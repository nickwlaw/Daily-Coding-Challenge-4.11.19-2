...
public class DCPApp {
	...
	public static void main(String[] args) {
		...
		boolean[][] boolMatrix = { { false, false, false, false },
								   { true, true, false, true },
								   { false, false, false, false },
								   { false, false, false, false } };
		int[] sCoords = { 3, 0 };
		int[] eCoords = { 0, 0 };
		System.out.println(test1(boolMatrix, sCoords, eCoords));
	}

	private static int test1(boolean[][] boolMatrix, int[] sCoords, int[] eCoords) {
		int steps = 0;
